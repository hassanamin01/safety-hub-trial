...
const getTabStyles = ({ isFocusVisible, isSelected, isHovered }: AriaTabRenderProps) => ({
    "button-brand": cx(
        ...
        /* Neutral selected/hover — brand reserved for primary CTAs (legacy / NGX policy) */
        isHovered && !isSelected && "bg-primary_hover text-secondary",
    ...
    underline: cx(
        ...
        isHovered && !isSelected && "border-border-secondary text-secondary",
        isSelected && "border-primary text-secondary",
        isFocusVisible && "outline-2 -outline-offset-2",
    ),
    line: cx(
...
const getColorStyles = (_: Partial<AriaTabRenderProps>) => ({
    "button-brand": "gray",
    "button-gray": "gray",
    "button-border": "gray",
    "button-minimal": "gray",
