...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                // Legacy NGX: default solid brand, white label; hover adds elevation (no darker fill); pressed = deeper fill + 1px black edge
                "rounded-[4px] border border-transparent bg-brand-solid text-white shadow-none ring-0",
                "hover:bg-brand-solid hover:shadow-sm",
                "active:border-black active:bg-brand-700 active:shadow-none",
                "data-loading:bg-brand-solid_hover data-loading:shadow-none",
                "disabled:border-transparent disabled:bg-disabled disabled:shadow-none disabled:ring-disabled_subtle",
                "*:data-icon:text-button-primary-icon hover:*:data-icon:text-button-primary-icon_hover",
            ].join(" "),
        },
        secondary: {
            root: [
                // Legacy gray ramp: #F2F2F2 → #E5E7EB hover → #D1D5DB pressed + black border
                "rounded-[4px] border border-transparent bg-[#F2F2F2] text-gray-900 shadow-none ring-0",
                "hover:bg-[#E5E7EB]",
                "active:border-black active:bg-[#D1D5DB]",
                "data-loading:bg-[#E5E7EB]",
                "disabled:border-transparent disabled:opacity-50",
                "*:data-icon:text-gray-700 hover:*:data-icon:text-gray-900",
            ].join(" "),
        },
        outline: {
            root: [
                "rounded-[4px] border border-[var(--input)] bg-transparent text-[var(--color-text-primary)] shadow-none ring-0",
                "hover:border-black hover:bg-transparent",
                "active:border-[#9CA3AF] active:bg-transparent",
                "data-loading:bg-transparent",
                "disabled:border-disabled disabled:opacity-50",
                "*:data-icon:text-fg-secondary hover:*:data-icon:text-fg-primary",
            ].join(" "),
        },
        tertiary: {
            root: [
        ...
        "primary-destructive": {
            root: [
                "rounded-[4px] border border-transparent bg-error-solid text-white shadow-none ring-0 outline-error",
                "hover:bg-error-solid hover:shadow-sm",
                "active:border-black active:shadow-none",
                "data-loading:bg-error-solid_hover data-loading:shadow-none",
                "disabled:border-transparent disabled:bg-disabled disabled:shadow-none disabled:ring-disabled_subtle",
        ...
        >
            ...
            {children && (
                <span
                    data-text
                    className={cx(
                        "inline-flex min-w-0 max-w-full items-center gap-1.5 transition-inherit-all",
