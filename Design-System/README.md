...
> **In this repository:** the parent app depends on this folder as **`"@untitledui/react": "file:./Design-System"`** (see root `package.json`). Edits here affect the shell and `@/components/ui` facades directly. Everything below is the upstream **Untitled UI React** project readme.
